      ...
      descriptions: [
        ...
        },
        {
          ...
          descriptions: [
            {
              content:
                '프로젝트 메인 개발자로 참여하였으며, 유사도 검색 모듈은 머신러닝 엔지니어분이 담당하고 API서버와 배치서버 개발은 모두 혼자 담당하였습니다. 전체 기여도는 약 80%가량으로, 하기 내용은 모두 직접 개발한 내용입니다.',
            },
          ],
        },
        {
      ...
      descriptions: [
        ...
        },
        {
          ...
          descriptions: [
            ...
            {
              content:
                '복잡하게 분산되어 있던 각 도메인과 서버들을 통합, 사용 서버 절반 수준으로 줄여 운영 부담 완화',
            },
            {
              content:
                '기존의 복잡한 DB 구조를 분석하고 컴팩트하게 통합 및 축소하여 직관적인 DB로 재설계',
            },
            {
              content:
