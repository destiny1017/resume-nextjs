...
const introduce: IIntroduce.Payload = {
  ...
  contents: [
    ...
    '저는 제 전문 분야에서의 능력을 인정 받는 것에서 무엇보다 큰 기쁨을 느껴 내가 담당한 업무에서 최고의 결과를 내기 위해 항상 진심으로 일하며, 퇴근 후나 주말에도 항상 학습을 게을리하지 않으려 노력합니다. "적당히 이 정도만 하면 됐지"하는 문화보다, 단 1%의 품질 향상을 위해서 끊임 없는 연구와 도전을 아끼지 않는 조직에서 함께 일하고 싶습니다 :)',
  ],
  sign: 'Daeho',
